...
function makeSound(key){
    ...
    switch (key) {
        ...
        case "t": var tom3 = new Audio("sounds/tom-3.mp3");
            tom3.play();
            break;


        case "y": var tom4 = new Audio("sounds/tom-4.mp3");
            tom4.play();
            break;
        ...
        case "c": var crash = new Audio("sounds/crash.mp3");
            crash.play();
            break;


        case "k": var kick = new Audio("sounds/acoustic-drum.wav");
            kick.play();
            break;
